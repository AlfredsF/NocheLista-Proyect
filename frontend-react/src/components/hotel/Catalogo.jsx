...
import { getAllHotelesLocal } from '../../data/hotelesData';
...
export default function Catalogo() {
  ...
  const cargarHoteles = async (params = {}) => {
    ...
    try {
      ...
      const locales = getAllHotelesLocal();
      if (Object.keys(params).length === 0 || !params.nombre && !params.ciudad && !params.estrellas && !params.precio_max) {
        setHoteles(locales);
      } else {
        setHoteles(locales);
      }
