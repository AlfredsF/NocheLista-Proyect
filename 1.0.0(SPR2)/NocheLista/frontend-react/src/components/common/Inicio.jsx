      ...
      <section className="hoteles-destacados">
        ...
        <div className="contenedor-tarjetas">
          <div className="tarjeta-hotel">
            <a href="/detalles_pag/detalles_plazaG.html" className="text-decoration-none text-dark">
          ...
          <div className="tarjeta-hotel">
            <a href="/detalles_pag/detalles_gangotena.html" className="text-decoration-none text-dark">
          ...
          <div className="tarjeta-hotel">
            <a href="/detalles_pag/detalles_pag_patioA.html" className="text-decoration-none text-dark">
